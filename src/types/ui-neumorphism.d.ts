...
declare namespace __UINeumorphism {
  ...
  export interface CardHeaderProps extends DefaultProps, CardContentCommonProps {
  ...
  export interface CardContentProps extends DefaultProps, CardContentCommonProps {}
  ...
  export interface ButtonProps extends DefaultProps, MouseEvents, CommonButtonProps {
    text?: String;
    block?: Boolean;
    active?: Boolean;
    outlined?: Boolean;
  ...
  // Fab
  export interface FabProps extends DefaultProps, MouseEvents, CommonButtonProps {
    top?: Boolean;
    left?: Boolean;
    right?: Boolean;
    fixed?: Boolean;
  ...
  // IconButton
  export interface IconButtonProps extends DefaultProps, MouseEvents, CommonButtonProps {
    text?: String;
    active?: Boolean;
    outlined?: Boolean;
  }
  ...
  // ToggleButton
  export interface ToggleButtonProps extends DefaultProps, MouseEvents, CommonButtonProps {
    value?: any;
    text?: String;
    outlined?: Boolean;
    selected?: Boolean;
  ...
  export interface ProgressCircularProps extends DefaultProps, CommonProgressProps {
    size?: Number;
    flat?: Boolean;
    width?: Number;
    rotate?: Number;
  ...
  export class ProgressCircular extends React.Component<ProgressCircularProps> {}

  export interface ProgressLinearProps extends DefaultProps, CommonProgressProps {
    height?: Number;
    active?: Boolean;
    striped?: Boolean;
    bordered?: Boolean;
  ...
  interface SelectionControlProps extends MouseEvents, CommonSelectionControlProps {
    name?: String;
    label?: String;
    checked?: Boolean;
    required?: Boolean;
  ...
  //RadioGroup
  export interface RadioGroupProps extends DefaultProps, CommonSelectionControlProps {
    vertical?: Boolean;
    onChange?: Function;
    children: React.ReactNode;
  }
